...
func (in *EnvoyExtensionFeatures) DeepCopyInto(out *EnvoyExtensionFeatures) {
	*out = *in
	...
	if in.ProtoMessageExtractions != nil {
		in, out := &in.ProtoMessageExtractions, &out.ProtoMessageExtractions
		*out = make([]ProtoMessageExtraction, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MethodExtraction) DeepCopyInto(out *MethodExtraction) {
	*out = *in
	if in.RequestExtractionByField != nil {
		in, out := &in.RequestExtractionByField, &out.RequestExtractionByField
		*out = make(map[string]ProtoMessageExtractionDirective, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ResponseExtractionByField != nil {
		in, out := &in.ResponseExtractionByField, &out.ResponseExtractionByField
		*out = make(map[string]ProtoMessageExtractionDirective, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MethodExtraction.
func (in *MethodExtraction) DeepCopy() *MethodExtraction {
	if in == nil {
		return nil
	}
	out := new(MethodExtraction)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProtoMessageExtraction) DeepCopyInto(out *ProtoMessageExtraction) {
	*out = *in
	if in.DescriptorSet != nil {
		in, out := &in.DescriptorSet, &out.DescriptorSet
		*out = make(PrivateBytes, len(*in))
		copy(*out, *in)
	}
	if in.Mode != nil {
		in, out := &in.Mode, &out.Mode
		*out = new(ProtoMessageExtractionMode)
		**out = **in
	}
	if in.ExtractionByMethod != nil {
		in, out := &in.ExtractionByMethod, &out.ExtractionByMethod
		*out = make(map[string]MethodExtraction, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProtoMessageExtraction.
func (in *ProtoMessageExtraction) DeepCopy() *ProtoMessageExtraction {
	if in == nil {
		return nil
	}
	out := new(ProtoMessageExtraction)
	in.DeepCopyInto(out)
	return out
}
