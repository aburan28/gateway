...
const (
	...
	// EnvoyFilterProtoMessageExtraction defines the Envoy HTTP proto message extraction filter.
	EnvoyFilterProtoMessageExtraction EnvoyFilter = "envoy.filters.http.proto_message_extraction"
